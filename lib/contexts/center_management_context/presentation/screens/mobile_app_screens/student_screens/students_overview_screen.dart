...
class StudentsOverviewScreen extends ConsumerStatefulWidget {
  final List<StudentEntity>? filterDataList;
  final FilterParams? params;
  const StudentsOverviewScreen({super.key, this.filterDataList, this.params});

  @override
  ConsumerState<StudentsOverviewScreen> createState() =>
      ...
      child: SafeArea(
        child: GestureDetector(
          ...
          child: Scaffold(
            ...
            appBar: OverviewScreenAppBar(
              label: S.of(context).studentsPageTitle,
            ),
