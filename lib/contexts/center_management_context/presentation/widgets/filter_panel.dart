...
import '../screens/mobile_app_screens/student_filter_screen.dart';
...
class _FilterPanelState extends State<FilterPanel> {
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        StudyLevelDropDown(width, isExpanded: true),
                      ],
                    ),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        DivisionDropDown(width, isExpanded: true),
                      ],
                    ),
                  ],
                ),
  ...
  Widget StudyLevelDropDown(double screenWidth, {bool isExpanded = false}) {
        ...
        children: [
          GestureDetector(
            ...
            child: AnimatedContainer(
              duration: const Duration(milliseconds: 300),
              curve: Curves.easeInOut,
              width: isExpanded ? 260 : (260 * screenWidth) / 1440,
  ...
  Widget DivisionDropDown(double screenWidth, {bool isExpanded = false}) {
    return AnimatedContainer(
      duration: const Duration(milliseconds: 300),
      curve: Curves.easeInOut,
      decoration: BoxDecoration(
...
/*
  Widget getFilterScreen(double width) {
    print(width);
    if (width > 1250.0) {
      return Container(
        alignment: Alignment.topCenter,
    ...
    } else if (width <= 1250.0 && width >= 938.0) {
      return Container(
        alignment: Alignment.topCenter,
        decoration: BoxDecoration(
          color: AppColors.surfaceContainerLowest,
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          StudyLevelDropDown(width, isExpanded: false),
                        ],
                      ),
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          DivisionDropDown(width, isExpanded: false),
                        ],
                      ),
                      const SizedBox(width: 16),
                      Column(
